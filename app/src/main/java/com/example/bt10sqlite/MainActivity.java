...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.getCount()==0){
            ...
            db.insertCa("Category 2","lenovo");
            db.insertCa("Category 3","Dell");
            db.insertCa("Category 4","Macbook");
            db.insertCa("Category 5","ViVo");
        }
        ...
        if (cursor.getCount()==0){
            ...
            db.insertC("PC05","Computer Asus 5","Category 1");
        }
